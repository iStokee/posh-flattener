...
It’s designed mainly for aidong in AI ingestion, but could be used for tasks like code review or archiving, where having all relevant source in one file might be useful.
